        ...
        <div>
            <nav className={`navbar navbar-expand-lg `} >
                <div className="container-fluid">
                    <a className={`navbar-brand text-${props.textMode}`} href="#">Navbar</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className={`nav-link text-${props.textMode}`} active aria-current="page" href="/TextArea">Home</a>
                            </li>
                            <li className="nav-item">
                                <a className={`nav-link text-${props.textMode}`} href="/About">About</a>
                            </li>
